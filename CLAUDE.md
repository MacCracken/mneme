# mneme — Claude Code Instructions
...
**mneme** — Cyrius port of a Rust project (0 lines preserved at `rust-old/`).
...
_TODO: one-or-two-sentence mission statement. What does mneme OWN in the stack? Durable — doesn't change per release._
...
cyrius build src/main.cyr build/mneme    # compile
